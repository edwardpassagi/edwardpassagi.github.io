...
export const metadata: Metadata = {
  ...
  keywords: 'Edward Passagi, Software Engineer, Backend Developer, Epic Systems, UIUC, Computer Science, Illinois, Urbana-Champaign',
  ...
  twitter: {
    card: 'summary',
    title: 'Edward Passagi - Software Engineer',
    description: 'Backend Engineer | Ex-Epic Systems | BS & MCS CS @ UIUC',
